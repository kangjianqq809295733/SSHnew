...
<html lang="en">
  ...
  <div class="container">
    ...
    <div class="row" style="margin-top:100px;">
    	<div class="col-md-12">
            <form method="post" class="form-horizontal" role="form" action="publish.action">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                 	<!-- 加载编辑器的容器 -->
					<script id="container"  type="text/plain" style="width:100%;height:200px;">请输入公告内容</script>
                </div>
              </div>
              <div class="form-group" align="center">
                <div class="col-sm-offset-2 col-sm-10">
                  <button type="submit" class="btn btn-default" onclick="fun()">发布</button>
                </div>
              </div>
            </form>
		</div>
